...
run("Label...", "format=Text starting=0 interval=5 x=5 y=38 font=18 text=[+ 6uM tub] range=18-399 use_text");
run("Label...", "format=Text starting=0 interval=5 x=5 y=56 font=18 text=[+ 114nM DCX WT] range=18-399 use_text");
